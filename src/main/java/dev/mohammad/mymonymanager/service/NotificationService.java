...
public class NotificationService {
    ...
    public void sendDailyIncomExpenseReminder() {
        log.info("Job started: sendDailyIncomExpenseReminder()");
        ...
        log.info("Job finished: sendDailyIncomExpenseReminder()");
    }


   @Scheduled(cron = "0 0 23 * * *", zone = "Europe/Stockholm")
    public void sendDaliyExpenseSummaty() {

package dev.mohammad.mymonymanager.config;


import dev.mohammad.mymonymanager.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:8080/api/v1.0"));
